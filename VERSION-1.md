...
Note: This algorithm is the initial version and is planned to evolve as more advanced features (for example, batch conversion or AI-based compression) are introduced.
